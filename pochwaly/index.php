...
<div class="nav">
    ...
    <a href="nabor/" class="menuBtn menuBtnA" style="color: rgb(255, 255, 255);">Nabór</a>
        ...
        <div id="MenuWrapper" class style="width: 100%; right: auto;">
            ...
            <a href="nabor.html">Nabór</a>
            <a href="kontakt.html">Kontakt</a>
            <a href="pochwaly.html">Pochwały</a>
            <a href="sad.html">Skargi</a>
        
            <div id="menuWrapperExpand" style="display: none;">
                <div id="menuWrapperExpandBack">
...
<section id="mainSection">
    ...
    <section id="secondSection2">
        <div id="svg-container">
            <svg width="100%" height="200px" viewBox="0 0 100 100" preserveAspectRatio="none" style="background-color: #6497b1;fill:#fff;transform: rotateX(180deg);">
               <polygon points="0 100,150 0,303 -1,0 0" class="svg-polygon"></polygon>
            </svg>
        </div>
        <div class="secondSectionWrapp31">
            <div class="secondSectionWrapp3" id="iawrapp" style="background-color: #6497b1; width: 75%;">
                <div>
                    <h3 style="color:#fff;">Dział komplementów <br>Internal Affairs</h3>
                    <p style="margin-bottom: 10px;;color: #fff;font-size: 20px;">• Tutaj możesz pochwalić funkcjonariusza/korpusu policji</p>
    ...
    <div class="form">
    <form action="submit.php" method="POST" class="form-support">
        <h3>Pochwały LSPD</h3>
        <p style="color: #fff">Wypełniając ten formularz, wyrażasz zgodę na warunki:</p>
        
        <button id="scrollbutton2" type="button" onclick="showSecondPage()">Kontynułuj</button>
        ...
        <div id="secondpage" style="display: none;">
            <div class="form-group">
                <label style="color: #fff;" for="name">Twoje imię i nazwisko *</label>
                <textarea class="form-control" name="name" required></textarea>
            </div>
            <div class="form-group">
                <label style="color: #fff;" for="birthdate">Data urodzenia? *</label>
                <input class="form-control" type="date" name="birthdate" required>
            </div>
            <div class="form-group">
                <label style="color: #fff;" for="officer">Imię, nazwisko lub numer odznaki funkcjonariusza *</label>
                <textarea class="form-control" name="officer" required></textarea>
            </div>
            <div class="form-group">
                <label style="color: #fff;" for="description">Opis pochwały *</label>
                <textarea class="form-control" name="description" required></textarea>
            </div>
            <button type="button" onclick="showFirstPage()">Z powrotem</button>
            <button type="submit">Potwierdzać</button>
        </div>
    </form>
</div>
...
<script>
    function showSecondPage() {
        ...
        document.getElementById('scrollbutton2').style.display = 'none'; // Ukryj przycisk
    }

    function showFirstPage() {
        document.getElementById('firstpage').style.display = 'block';
        document.getElementById('secondpage').style.display = 'none';
        document.getElementById('scrollbutton2').style.display = 'block'; // Przywróć przycisk
    }
</script>
...
.form-support .form-control:focus {
  z-index: 2;
}
...
.form-support input[type="password"] {
  margin-bottom: 10px;
...
<footer id="basicFooter" style="margin-top:2em">
    ...
    <script>
    $('.footerMobileExpand').hide();
    $(document).ready(function(){
        $('.footerMobileWrapper').click(function(){
